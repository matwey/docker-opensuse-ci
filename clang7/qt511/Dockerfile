...
RUN zypper -n --gpg-auto-import-keys install --no-recommends --auto-agree-with-licenses --force-resolution clang7 libQt5Widgets-devel libQt5Test-devel libQt5Gui-devel libQt5Core-devel cmake make
